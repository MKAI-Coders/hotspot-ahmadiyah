...
<div id="wrap">
	...
	<center>
	<b>Cinta untuk Semua, Kebencian Tidak untuk Siapapun</b> </br><small>"Islam sejati membawa ajaran yang penuh dengan kedamaian, cinta, dan kasih sayang"</small>
		...
		<div class="col-md-8 col-sm-12">
			...
			<div class="slideshow-container">
				...
				<div class="mySlides fade">
				  <img src="Image/CtC.jpg" style="width:100%">
				  <div class="text" ></div>
				</div>
				
				<div class="mySlides fade">
				  <img src="Image/haripahlawan.jpg" style="width:100%">
				  <div class="text" ></div>
				</div>
				
				<div class="mySlides fade">
				  <img src="Image/sumpahpemuda.jpg" style="width:100%">
				  <div class="text" ></div>
				</div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- <form id="loginForm" class="form-horizontal" role="form" action="<?php echo $linkloginonly; ?>" method="post"> -->
							...
							<form id="loginForm" class="form-horizontal" role="form" action="http://loveforall.id/hotspot/dev/login2.php" method="post">
