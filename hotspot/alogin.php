...
<head>
	...
	<meta http-equiv="refresh" content="4;url=http://rajapena.org" />
            ...
            <div class="row">
                <div class="alert alert-success">
					...
					<?php 
						...
						/*
						$message[0] = "Miftaahul Jannati As Sholaah (HR Ahmad) Artinya: Kunci surga adalah shalat - loveforall.id";
						$message[1] = "Innamal a'maalu bin niyyaat (HR Bukhari) Artinya: Setiap amal sesuai dengan niatnya - loveforall.id";
						$message[2] = "Ad du'aau silaahul mu'min (Jamius Saghir) Artinya: Do'a adalah senjata orang beriman - loveforall.id";
						$message[3] = "Al kalimatut thayyibatu shadaqah (HR Bukhari) Artinya: Berkata yang baik adalah sedekah - loveforall.id";
						$message[4] = "Ballighuw anniy walau aayah (HR Bukhari) Artinya: Sampaikan dariku walau satu ayat - loveforall.id";
						*/
